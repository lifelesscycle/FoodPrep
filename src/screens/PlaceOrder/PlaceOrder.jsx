...
import Login from './../Login/Login'; // Update this path to match your file structure
...
const PlaceOrder = ({ cart, setCart }) => {
  ...
  const handlePlaceOrder = async (e) => {
    ...
    // Prepare order data according to FastAPI Pydantic model
    const orderData = {
  ...
  return (
    <div className="checkout-container">
      ...
      {/* Replace the inline modals with the Login component */}
      <Login 
        isOpen={showLogin}
        onClose={closeLogin}
        onLogin={handleLogin}
